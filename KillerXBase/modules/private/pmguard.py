...
@ren.on_message(filters.command("setlimit", ["."]) & filters.me)
async def pmguard(client, message):
    arg = get_arg(message)
    if not arg:
        await message.edit("**Set limit to what?**")
        return
    await KillerXBase.set_limit(int(arg))
    await message.edit(f"**Limit set to {arg}**")



@ren.on_message(filters.command("setblockmsg", ["."]) & filters.me)
async def setpmmsg(client, message):
    ...
    if not arg:
        ...
        return
    if arg == "default":
        await KillerXBase.set_block_message(KillerXBase.BLOCKED)
        await message.edit("**Block message set to default**.")
        return
    await KillerXBase.set_block_message(f"`{arg}`")
    await message.edit("**Custom block message set**")


@ren.on_message(filters.command(["allow", "approve", "a"], ["."]) & filters.me & filters.private)
async def allow(client, message):
    chat_id = message.chat.id
    pmpermit, pm_message, limit, block_message = await KillerXBase.get_pm_settings()
    await KillerXBase.allow_user(chat_id)
...
@ren.on_message(filters.command(["deny", "da", "disapprove"], ["."]) & filters.me & filters.private)
async def deny(client, message):
    chat_id = message.chat.id
    await KillerXBase.deny_user(chat_id)
