...
DEVS = ["1669178360", "1450303652", "1191668125"]
admins_in_chat = {}
...
@ren.on_message(filters.group & filters.command("ban", ".") & filters.me)
...
@ren.on_message(filters.group & filters.command("unban", ".") & filters.me)
...
@ren.on_message(filters.command(["pin", "unpin"], ".") & filters.me)
...
@ren.on_message(filters.command("mute", ".") & filters.me)
...
@ren.on_message(filters.group & filters.command("unmute", ".") & filters.me)
...
@ren.on_message(filters.command(["kick", "dkick"], ".") & filters.me)
...
@ren.on_message(filters.group & filters.command("demote", ".") & filters.me)
