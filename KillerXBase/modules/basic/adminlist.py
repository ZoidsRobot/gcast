...
from KillerXBase.helper.parser import *
from KillerXBase.modules.help import *
from KillerXBase.helper.cmd import *

@ren.on_message(filters.me & filters.command(["admins", "adminlist"], cmd))
...
@ren.on_message(filters.me & filters.command(["everyone", "mentionall"], cmd))
...
@ren.on_message(filters.me & filters.command(["botlist", "bots"], cmd))
