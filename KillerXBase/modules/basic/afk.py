...
from KillerXBase.helper.PyroHelpers import GetChatID, ReplyCheck
...
@ren.on_message(filters.command("afk", cmd) & filters.me, group=3)
...
if AFK:
   @ren.on_message(filters.me, group=3)
